    ...
    <div className='bottom'>
        ...
        <h4>Courses</h4>
            <ul className="courselist">
                <li className="list">VFX</li>
                <li className="list">ANIMATION</li>
                <li className="list">MULTIMEDIA</li>
                <li className="list">DIGITAL MARKETING</li>
                <li className="list">GAMING</li>
            </ul>
        </div>
        <div className="contact">
        <h4>Contact Us</h4>
            <h6>Ph:8500685181</h6>
            <h6>Email:abc@gmai.com</h6>
            <p>
            Address: P, SPELLBOUND TOWERS, 148, Bhaskar Nagar Rd, Manik Sai Enclave, Sainikpuri, Secunderabad, Telangana 500094
            </p>
        </div>
